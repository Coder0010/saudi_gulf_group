        ...
        <div class="card-body">
            <form method="POST" action="{{ route('backend.sections.update') }}" class="form-row" enctype='multipart/form-data'>
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea name="description" id="description" class="form-control" rows="3">{{ $storyPageTwoSection->description }}</textarea>
                </div><!-- description -->
                <div class="form-group col-md-12">
                    <label for="sub_description">sub description</label>
                    <textarea name="sub_description" id="sub_description" class="form-control" rows="3">{{ $storyPageTwoSection->sub_description }}</textarea>
                </div><!-- sub_description -->
