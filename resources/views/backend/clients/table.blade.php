        ...
        <tbody>
            @forelse ($clients as $row)
                <tr>
                    ...
                    <td class="align-middle">
                        <a href="{{ route('backend.clients.edit', $row) }}">
                        ...
                        <form id="client-destory-form-{{ $row->id }}" action="{{ route('backend.clients.destroy', $row) }}" method="POST" class="none"> @method('delete') @csrf </form>
                    </td>
                </tr>
            @empty
                <tr>
